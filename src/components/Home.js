...
import HeavenHome from '../images/the-heaven-home.png';
...
const Home = () => {
    ...
    let resume = () => {
        let path = `https://drive.google.com/file/d/1WdCXA2fjluvjGbgifC5TUJzyI4UWWq3i/view?usp=sharing`;
    ...
    return (
        <>
            ...
            <div className="landing">
                <div className="intro">
                    <h3>I'M <span>Trp Singh</span><br />Full-Stack Developer </h3>
            ...
            <section className="skills">
                ...
                <div className="cards">
                    <a href="https://the-heaven-home.netlify.app" target='_blank' rel="noreferrer">
                        <div className="skill-card">
                            <img src={HeavenHome} alt="The Heaven Home logo" />
                            <h2>THE HEAVEN HOME</h2>
                        </div>
                    ...
                    <a href="https://singular-bonbon-316e2b.netlify.app" target='_blank' rel="noreferrer">
                        <div className="skill-card">
                            <img src={toDoList} alt="to do list logo" />
                            <h2>To DO List</h2>
                        </div>
                    </a>
                    <div className="skill-card">
